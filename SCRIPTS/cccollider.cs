...
public class cccollider : MonoBehaviour
{
    ...
    public static bool ClosestPointOnSurface(Collider collider, Vector3 to, float radius, out Vector3 closestPointOnSurface)
    {
        ...
        {
            closestPointOnSurface = cccollider.ClosestPointOnSurface((BoxCollider)collider, to);
            return true;
        }
        else if (collider is SphereCollider)
        {
            closestPointOnSurface = cccollider.ClosestPointOnSurface((SphereCollider)collider, to);
            return true;
        }
        else if (collider is CapsuleCollider)
        {
            closestPointOnSurface = cccollider.ClosestPointOnSurface((CapsuleCollider)collider, to);
            return true;
        }
        else if (collider is CharacterController)
        {
            closestPointOnSurface = cccollider.ClosestPointOnSurface((CharacterController)collider, to);
            return true;
        }
